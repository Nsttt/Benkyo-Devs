...
function Points() {
    ...
    return (
        <div className="p-5">
            ...
            <ul className="p-5">
                <li className="flex items-center border inner-shadow p-3 w-44 m-3">
                    <Image src={facil} width={50} height={50} />{' '}
                    <TiArrowRight /> {easy}
                </li>
                <li className="flex items-center border inner-shadow p-3 w-44 m-3">
                    <Image src={media} width={50} height={50} />{' '}
                    <TiArrowRight /> {medium}
                </li>
                <li className="flex items-center border inner-shadow p-3 w-44 m-3">
                    <Image src={dificil} width={50} height={50} />{' '}
                    <TiArrowRight /> {hard}
                </li>
            </ul>
        </div>
